Base code for paper "[Searching for waveforms in spatially-filtered epileptic ECoG][accepted_paper]", to appear in the 10th 10th International IEEE/EMBS Conference on NeuralEngineering ([NER][NER]).
